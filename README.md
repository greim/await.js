...
<table summary="overview of needs api">
  ...
  <tbody>
    ...
    <tr>
      <td class="need-method">needs.run(callback[, context])</td>
    ...
    <tr>
      <td class="need-method">needs.onkeep(callback[, context])</td>
    ...
    <tr>
      <td class="need-method">needs.onfail(callback[, context])</td>
    ...
    <tr>
      <td class="need-method">needs.onresolve(callback[, context])</td>
    ...
    <tr>
      <td class="need-method">needs.keep(thing[, data])</td>
    ...
    <tr>
      <td class="need-method">needs.fail(reason)</td>
      <td>Fail the promise for the given <code>reason</code>.</td>
      <td>itself</td>
    </tr>
    <tr>
      <td class="need-method">needs.take(otherNeeds[, mapping])</td>
    ...
    <tr>
      <td class="need-method">needs.timeout(milliseconds)</td>
