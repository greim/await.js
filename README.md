...
<table summary="overview of needs api">
  ...
  <tbody>
    <tr>
      <td><pre>var needs = new Needs(thing1, thing2, ...)</pre></td>
    ...
    <tr>
      <td><pre>needs.run(callback[, context])</pre></td>
    ...
    <tr>
      <td><pre>needs.onkeep(callback[, context])</pre></td>
    ...
    <tr>
      <td><pre>needs.onfail(callback[, context])</pre></td>
    ...
    <tr>
      <td><pre>needs.onresolve(callback[, context])</pre></td>
    ...
    <tr>
      <td><pre>needs.keep(thing[, data])</pre></td>
    ...
    <tr>
      <td><pre>needs.fail(reason)</pre></td>
      <td>Fail the promise for the given <code>reason</code>.</td>
      <td>itself</td>
    </tr>
    <tr>
      <td><pre>needs.take(otherNeeds[, mapping])</pre></td>
    ...
    <tr>
      <td><pre>needs.timeout(milliseconds)</pre></td>
